<template>
    <div class="relative bg-white">
      <div class="w-screen mx-auto">
          <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10 px-5">
          ...
          <nav class="hidden md:flex space-x-10">
              ...
              <button type="button" class="text-gray-500 group bg-white rounded-md inline-flex items-left text-base font-medium hover:text-gray-900 focus:outline-none" aria-expanded="false">
                  <span>Search</span>
              </button>
              </div>
